          ...
          children: [
            Container(
              ...
              ReusableIconButton(
                ...
                screenWidth: MediaQuery.of(context).size.width, // Передаём ширину экрана
                iconColor: Colors.black, // Цвет иконки
                            ...
                            child: Container(
                              ...
                              child: LinearProgressIndicator(
                                ...
                                valueColor: AlwaysStoppedAnimation<Color>(
                                  isDarkTheme ? AppColors.blueSand : Colors.blue, // Цвет линии в тёмной теме
                                ),
                              ),
                            ),
                          ),
                            ...
                            child: Column(
                              children: [
                                Container(
                                  decoration: BoxDecoration(
                                    color: isDarkTheme
                                        ? AppColors.blueSand // Цвет контейнера в тёмной теме
                                        : AppColors.violetSand, // Цвет в светлой теме
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: isDarkTheme
                                        ? AppColors.blueSand // Цвет точки в тёмной теме
                                        : Colors.blue, // Цвет точки в светлой теме
            ...
            Container(
              ...
              child: StreamBuilder<QuerySnapshot>(
                ...
                builder: (context, snapshot) {
                  ...
                  final typesWithColors = items.fold<Map<String, String>>(
                      {}, (map, item) {
                  ...
                  return ListView(
                    ...
                    children: typesWithColors.entries.map((entry) {
                      return _buildCategoryButton(entry.key, entry.value,isDarkMode);
                    }).toList(),
                  );
                },
              ),
        ...
        floatingActionButton: ValueListenableBuilder<List<String>>(
          ...
          builder: (context, selectedItems, child) {
            ...
            return selectedItems.isNotEmpty
              ...
              onPressed: () {
                deleteSelectedItems(context); // Удаление выделенных элементов
              },
              child: Icon(Icons.delete),
              backgroundColor: Colors.redAccent, // Красный фон для удаления
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(16), // Прямоугольная форма
              ),
            )
                : Container(
              ...
              decoration: isDarkTheme
                  ? BoxDecoration(
                gradient: AppColors.blueGradient, // Градиент для темной темы
              ...
              child: FloatingActionButton(
                ...
                backgroundColor: isDarkTheme
                    ...
                    : Colors.blueAccent, // Синий цвет для светлой темы
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(16), // Прямоугольная форма
                ),
                elevation: 0, // Убираем тень для градиента
              ),
            );
          },
        ),
